  ...
  <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-green-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 font-sans py-10 flex flex-col items-center px-4">
    <div className="bg-white dark:bg-gray-800 rounded-2xl p-10 shadow-lg max-w-5xl w-full">
      <div className="w-14 h-14 bg-green-100/30 dark:bg-green-900/20 rounded-full mx-auto flex items-center justify-center mb-6">
        <span role="img" aria-label="study" className="text-3xl">📚</span>
      </div>
      ...
      {motivationalLines.map((line, idx) => (
        <div key={idx} className="text-green-700 dark:text-green-400 font-semibold text-center mb-3">
          {line}
        </div>
      ))}
      ...
      <h3 className="text-green-600 dark:text-green-400 font-semibold mt-8 mb-3">Coding Platforms</h3>
      <ul className="list-disc list-inside mb-6 text-gray-700 dark:text-gray-400">
        {codingResources.map((r) => (
          <li key={r}>{r}</li>
        ))}
      </ul>
      <h3 className="text-green-600 dark:text-green-400 font-semibold mb-3">Sample Weekly Timetable</h3>
      <table className="w-full bg-green-50/20 dark:bg-green-900/20 rounded-lg text-sm mb-6 border border-green-200/30 dark:border-green-700/30">
        <thead>
          <tr className="text-green-800 dark:text-green-300">
            <th className="py-2 px-3 border-b border-green-200/30 dark:border-green-700/30 text-left">Day</th>
            <th className="py-2 px-3 border-b border-green-200/30 dark:border-green-700/30 text-left">Morning</th>
            <th className="py-2 px-3 border-b border-green-200/30 dark:border-green-700/30 text-left">Midday</th>
            <th className="py-2 px-3 border-b border-green-200/30 dark:border-green-700/30 text-left">Evening</th>
          </tr>
        </thead>
        <tbody className="text-gray-800 dark:text-gray-200">
          {timetable.map((row) => (
            <tr key={row.day} className="hover:bg-green-100/20 dark:hover:bg-green-800/20 transition-colors">
              <td className="py-2 px-3 border-b border-green-200/30 dark:border-green-700/30 font-semibold">{row.day}</td>
              <td className="py-2 px-3 border-b border-green-200/30 dark:border-green-700/30">{row.morning}</td>
              <td className="py-2 px-3 border-b border-green-200/30 dark:border-green-700/30">{row.midday}</td>
              <td className="py-2 px-3 border-b border-green-200/30 dark:border-green-700/30">{row.evening}</td>
            </tr>
          ))}
        </tbody>
      </table>
