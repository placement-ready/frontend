...
const About: React.FC = () => (
  <main className="min-h-screen bg-gradient-to-b from-green-50 to-white dark:from-gray-900 dark:to-gray-800 py-12 px-4">
    <section className="max-w-3xl mx-auto text-center">
      <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-green-100 dark:bg-green-900 mb-4 overflow-hidden">
        <Image
          src="/brain.png"
    ...
    <section className="max-w-xl mx-auto mt-8 text-center">
      <span className="block text-green-800 dark:text-green-300 bg-green-100 dark:bg-green-900 px-4 py-2 rounded-lg text-base md:text-lg font-semibold">
