...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center px-4 sm:px-6 lg:px-8 relative">
      <div className="max-w-xl w-full text-center relative z-10">
        <div>
          <div className="text-8xl sm:text-9xl lg:text-[12rem] font-bold bg-linear-to-r from-green-500 via-emerald-600 to-green-700 dark:from-green-400 dark:via-emerald-500 dark:to-teal-500 bg-clip-text text-transparent select-none">
            404
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <Link
            href="/"
            className="group flex items-center gap-3 px-6 py-3 sm:px-8 sm:py-4 text-sm sm:text-base rounded-xl text-white bg-linear-to-r from-green-600 to-emerald-600 dark:from-green-500 dark:to-emerald-500 hover:from-green-700 hover:to-emerald-700 transition-all duration-200 shadow-lg"
          >
