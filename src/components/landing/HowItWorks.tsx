...
import { ClipboardPenLine, MessageSquare, Sparkles } from 'lucide-react';
...
const steps = [
  {
    title: 'Set the focus',
    description: 'Pick the role, skills, and company scope you want to drill.',
    Icon: ClipboardPenLine,
  },
  {
    title: 'Run the mock',
    description: 'Answer guided prompts while the AI tracks delivery and timing.',
    Icon: MessageSquare,
  },
  {
    title: 'Review and improve',
    description: 'Get concise notes, scorecards, and next steps in under a minute.',
    Icon: Sparkles,
  },
];
    ...
    <SectionShell className="py-24">
      ...
      >
        ...
        <motion.p
          ...
          variants={fadeUp}
        >
          Each step keeps you moving without noise. No filler, just a clear path from setup to
          action.
        </motion.p>
      </motion.div>
