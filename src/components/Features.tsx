    ...
    <div className="max-w-7xl mx-auto relative z-10">
      <div className="flex flex-col items-center mb-16">
        ...
        <div className="text-center max-w-3xl">
          <p className="text-gray-600 dark:text-gray-300 text-lg sm:text-xl leading-relaxed mb-2">
        ...
        {features.map(({ title, icon, description, highlight }, idx) => (
          ...
          >
            ...
            <div className="relative z-10 flex-1">
              <h3 className="font-bold text-gray-900 dark:text-white text-xl mb-3 group-hover:text-emerald-800 dark:group-hover:text-emerald-400 transition-colors duration-300">
                {title}
              </h3>
              <p className="text-gray-600 dark:text-gray-300 text-base leading-relaxed group-hover:text-gray-700 dark:group-hover:text-gray-400 transition-colors duration-300">
                {description}
              </p>
            </div>

            {/* Decorative arrow */}
            <div className="absolute bottom-6 right-6 w-6 h-6 text-emerald-500 dark:text-emerald-400 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0">
