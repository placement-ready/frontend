...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen w-full flex flex-col justify-between bg-gradient-to-br from-green-50 via-emerald-50 to-green-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 pt-22 md:pt-24">
      {/* Centered main content */}
      <div className="flex-1 flex flex-col justify-center items-center text-center px-2 sm:px-4">
        {/* Logo / Icon */}
        <div className="mx-auto rounded-2xl w-16 h-16 flex items-center justify-center mb-6 shadow-lg bg-gradient-to-tr from-emerald-500 to-green-400 dark:from-emerald-600 dark:to-green-500">
          <Image
            src="/brain.png"
            alt="Brain Logo"
            width={36}
        ...
        {/* Headline */}
        <h1 className="text-4xl sm:text-6xl lg:text-5xl font-bold leading-tight mb-2 max-w-3xl text-gray-900 dark:text-white">
          From nervous to natural{' '}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600 dark:from-emerald-400 dark:to-green-300">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10 w-full sm:w-auto">
          <button
            ...
            className="bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold py-3 px-8 rounded-lg shadow-lg hover:scale-105 transition w-full sm:w-auto dark:from-green-500 dark:to-emerald-500"
          >
            Start Practicing
          </button>
          <button
            onClick={() => router.push('/about')}
            className="border border-gray-300 font-semibold py-3 px-8 rounded-lg bg-white hover:bg-gray-50 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-100 dark:hover:bg-gray-700 w-full sm:w-auto"
          >
            About Us
          </button>
        </div>
      ...
      <div className="w-full bg-white/60 backdrop-blur-sm py-8 dark:bg-gray-900/60">
...
const StatCard = ({
  ...
  <div className="group relative bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl hover:scale-105 transition-all duration-300 overflow-hidden dark:bg-gray-800 dark:border-gray-700">
