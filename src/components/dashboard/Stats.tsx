...
const ProgressBar = ({
  ...
  <div className="space-y-1">
    <div
      className={`w-full ${height} bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden shadow-inner`}
    >
      <motion.div
        initial={{ width: 0 }}
...
const Card = ({
  ...
  >
    ...
    <div className="space-y-3">
      <div className="font-semibold text-gray-700 dark:text-gray-200 text-sm lg:text-base leading-tight">
        {children}
      </div>
