      ...
      <div className="relative z-10">
        ...
        >
          ...
          >
            ...
            <div className="text-gray-600 dark:text-gray-300 font-medium">Interviews Completed</div>
            <div className="text-sm text-blue-500 dark:text-blue-300 mt-2">+3 this month</div>
          </motion.div>
          ...
          >
            ...
            <div className="text-gray-600 dark:text-gray-300 font-medium">Areas to Improve</div>
            <div className="text-sm text-purple-500 dark:text-purple-300 mt-2">Focus needed</div>
          </motion.div>
          ...
          <motion.div
            ...
            className="bg-white dark:bg-gray-800 rounded-xl p-6 text-center shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300"
          >
            <div className="text-3xl font-bold text-orange-600 dark:text-orange-400 mb-2">7</div>
            <div className="text-gray-600 dark:text-gray-300 font-medium">Days Streak</div>
            <div className="text-sm text-orange-500 dark:text-orange-300 mt-2">Keep it up!</div>
          </motion.div>
        </motion.div>
      </div>
    </section>
